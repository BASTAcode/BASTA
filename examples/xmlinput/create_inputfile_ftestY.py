...
def define_input(define_io, define_fit, define_output, define_plots, define_intpol):
    ...
    define_io["outputpath"] = os.path.join(BASTADIR, "examples", "output/ftestY")
    ...
    define_io["asciifile"] = os.path.join(BASTADIR, "examples/data", "16CygAy.ascii")
    define_io["params"] = (
        "starid",
        "RA",
        "DEC",
