...
class parameters:
    ...
    params = [
              ...
              ('d02fit', r'microHz', r'$\delta \nu_\mathrm{02}$', r'Small frequency separation computed as a weighted fit around numax in a similar way as `dnufit`', '#D36E70'),
              ('d02mean', r'microHz', r'$\delta \nu_\mathrm{02}$', r'Small frequency separation computed as a simple mean of all positive values of `d02`', '#D36E70'),
