...
class freqtypes:
    ...
    freqs = ["freqs"]
    glitches = ["glitches"]
    grtypes = ["gr010", "gr02", "gr01", "gr10", "gr012", "gr102"]
    epsdiff = ["e01", "e02", "e012"]
    alltypes = [*freqs, *glitches, *grtypes, *rtypes, *epsdiff]
    defaultrtypes = ["r01"]
...
class parameters:
    ...
    params = [
              ...
              ('fdnuSer', None, r'f$_\Delta \nu$ (Serenelli 17)', r'Correction factor for large frequency separatoin from Serenelli+17', pcol),
              ('nummodSer', None, r'N$_\mathrm{modes}$ (Serenelli 17)', r'Number of modes used in the corrections from Serenelli+17', pcol),
              ('errflagSer', None, r'error$_\mathrm{flag}$ (Serenelli 17)', r'Error output of the corrections from Serenelli+17', pcol),
